...
const FIXES: Fix[] = [
  ...
  },
  {
    ...
    tag: "made. staff",
    accent: "#bd9b4e",
    promise: "We become your team. No payroll.",
    line: "The tech, the admin, the day-to-day — handled, then automated. Big-4 calibre, a fraction of the cost.",
    href: "https://staff.made-by-ac.com",
    cta: "See made. staff",
    proof: "0",
  ...
  },
  {
    ...
    line: "Identity, packaging and sites that are unmistakably yours — designed, never assembled from a template.",
    href: "/work",
    cta: "See the work",
    proof: "1 of 1",
...
export function ProblemPicker() {
  ...
  return (
    <section id="fix" className="relative bg-ink text-paper py-28 md:py-40 overflow-hidden">
